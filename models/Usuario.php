<?php
    class Usuario extends Conectar{
       ...
       /*TODO: Actualizar la información de la encuesta según ID */
        public function update_encuesta_respuestas($usu_id, $p_1_c, $p_2_c, $p_3_c, $p_4_t, $p_5_c, $p_6_c, $p_7_c, $p_8_t, $p_9_c, $p_10_c, $p_11_t, $p_12_c, $p_13_c) {
        $conectar = parent::conexion();
        parent::set_names();
        $sql = "UPDATE tm_usuario AS u
                JOIN td_curso_usuario AS c ON u.usu_id = c.usu_id
                SET 
                    u.p_1_c = ?,
                    u.p_2_c = ?,
                    u.p_3_c = ?,
                    ...
                    u.p_13_c = ?,
                    u.est_encuesta = 1,
                    u.fecha_respuesta = CURRENT_TIMESTAMP,
                    c.est = 1
                WHERE u.usu_id = ?";
                $sql = $conectar->prepare($sql);
                // Bind de los valores para cada columna    
                $sql->bindValue(1, $p_1_c);
                $sql->bindValue(2, $p_2_c);
                $sql->bindValue(3, $p_3_c);
                $sql->bindValue(4, $p_4_t);
                $sql->bindValue(5, $p_5_c);
                $sql->bindValue(6, $p_6_c);
                $sql->bindValue(7, $p_7_c);
                $sql->bindValue(8, $p_8_t);
                $sql->bindValue(9, $p_9_c);
                $sql->bindValue(10, $p_10_c);
                $sql->bindValue(11, $p_11_t);
                $sql->bindValue(12, $p_12_c);
                $sql->bindValue(13, $p_13_c);
                $sql->bindValue(14, $usu_id);
            // Ejecutar el query
                $sql->execute();
                return $resultado = $sql->fetchAll();
            }
