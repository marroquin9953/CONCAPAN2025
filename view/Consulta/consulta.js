...
$(document).on("click","#btnconsultar", function(){
    ...
    if (usu_dni.length == 0){
        Swal.fire({
            ...
            text: 'Campos vacios',
            icon: 'error',
            confirmButtonText: 'Volver intentar'
        })
    }else{
        ...
        $.post("../../controller/usuario.php?op=consulta_dni",{usu_dni : usu_dni}, function (data) {
            if (data.length>0){
                ...
                $("#lbldatos").html("Usuario : "+data.usu_apep+" "+data.usu_apem+" "+data.usu_nom);
                ...
                $('#cursos_data').DataTable({
                    ...
                    "language": {
                        ...
                        "sEmptyTable":     "Ningún dato disponible hasta completar el feedback",
